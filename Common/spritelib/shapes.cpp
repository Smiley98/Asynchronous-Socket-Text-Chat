...
namespace spritelib
{
	...
	*/
	...
	void Shapes::ShapesShader::init_shader()
	{
		...
		s_vert->load_shader(Shader::VERTEX, "../Common/assets/BlankVert.glsl")
			.compile_shader();

		s_geom->load_shader(Shader::GEOMETRY, "../Common/assets/FilledCircleGeom.glsl")
			.compile_shader();

		s_geom2->load_shader(Shader::GEOMETRY, "../Common/assets/LineShaderGeom.glsl")
			.compile_shader();

		s_geom3->load_shader(Shader::GEOMETRY, "../Common/assets/FilledTriangleGeom.glsl")
			.compile_shader();

		s_frag->load_shader(Shader::FRAGMENT, "../Common/assets/ShapeFrag.glsl")
			.compile_shader();
